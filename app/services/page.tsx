...
export const metadata: Metadata = {
  title: "サービスのご案内｜社会福祉法人 三恵会｜さいたま市西区",
  description:
    "三恵会（さいたま市西区）のデイサービス・在宅介護支援センター・地域包括支援センター。日帰り通所介護・ケアプラン作成・高齢者総合相談まで対応。まずはお気軽にご相談ください。",
};
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-3">
                  ...
                  <div className="lg:col-span-1 relative overflow-hidden min-h-[180px]">
                    <img src={s.image} alt={s.imageAlt} className="w-full h-full object-cover absolute inset-0" loading="lazy" />
