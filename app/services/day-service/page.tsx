...
export default function DayServicePage() {
  return (
    <>
      ...
      {/* 3. Photo Slider */}
      <PhotoSlider slides={[
        { label: "ふれあいかん 外観・エントランス" },
        { label: "ふれあいかん 活動・レクリエーション" },
        { label: "ふれあいかん 食事・入浴サービス" },
      ]} />
      ...
      <section className="bg-primary-light py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="group inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-white font-bold px-7 py-3.5 rounded-full transition-all duration-200 hover:shadow-md">
              お問い合わせはこちら
              <svg className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </Link>
            <a href="tel:0175-34-3297" className="inline-flex items-center justify-center gap-2 bg-white hover:bg-primary-light text-primary font-bold px-7 py-3.5 rounded-full border border-border transition-all duration-200 hover:shadow-sm">
