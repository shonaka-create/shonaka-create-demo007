    ...
    <>
      ...
      <section className="bg-primary-light py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/recruit"
            className="group inline-flex items-center gap-2 bg-primary hover:bg-primary-dark text-white font-bold px-8 py-4 rounded-full transition-all duration-200 hover:shadow-md"
          >
            採用情報を見る
